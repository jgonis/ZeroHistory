...
["", "zerohistory.dart", , Z, {
  "^": "",
  main: [function() {
    $.gibson = document.getElementById("gibson");
    P.Future_Future$delayed(P.Duration$(0, 0, 0, 100, 0, 0), Z.fade$closure(), null);
  }, "call$0", "main$closure", 0, 0, 1],
  fade: [function() {
    J.set$color$x($.gibson.style, "white");
  }, "call$0", "fade$closure", 0, 0, 1]
},
1],
]);
...
//# sourceMappingURL=zerohistory.dart.js.map
